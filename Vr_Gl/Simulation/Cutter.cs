...
namespace Vr_Gl.Simulation
{
    public class Cutter
    {
        ...
        public Cutter(List<Triangle> tris, string texturePath = "D:/cutter.")
        {
            Tree = new AabbTree(tris);
            this.Texture = AssetsLoader.LoadTexture(texturePath);
        }

        public Cutter(string fileName, Vector3 initialPos, string texturePath = "D:/cutter.") : this(fileName)
        {
