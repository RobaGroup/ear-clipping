...
namespace Vr_Gl.Tree
{
    public class ParallelSort
    {
        ...
        public static void QuicksortSequential<T>(List<T> arr) where T : IComparable<T>
        {
        ...
        private static void QuicksortSequential<T>(List<T> arr, int left, int right)
        ...
        private static void QuicksortParallel<T>(List<T> arr, int left, int right)
            where T : IComparable<T>
        {
